 ...
 * @return {!Object|false} A service instance.
 */
IocContainer.prototype.getService = function (key, optional) {
 ...
 */
IocContainer.prototype.getServiceFromMiddleware_ = function (key) {
 ...
 * @param {!Function|Object|function():!Object} factory_or_instance A service.
 */
IocContainer.prototype.addNewService = function (key, factory_or_instance) {
 ...
 */
IocContainer.prototype.addFactoryMiddleware = function (createService) {
 ...
 */
IocContainer.prototype.getDependencyList_ = function (Class) {
  if (!Class.prototype) {
...
/**
 * @return {!IocContainer} A child container.
 */
IocContainer.prototype.createChildContainer = function () {
  var options = {};
  options.factories = Object.create(this.factories_);
  options.instances = Object.create(this.instances_);

  var child = new IocContainer(options);
  return child;
};
